...
def test_execute_url_extractor():
    ...
    assert set(urls) == {"https://example.com", "http://test.org", "https://example.com/path"}
...
def test_execute_hash_generator():
    ...
    assert data3["result"]["hash"] == "59e1748777448c69de6b800d7a33bbfb9ff1b463e44354c3553bcdb9c666fa90125a3c79f90397bdf5f6a13de828684f"
