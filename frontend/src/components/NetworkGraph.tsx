 ...
 * Wrapped NetworkGraph in React.memo to prevent expensive vis-network re-instantiation
 * and layout thrashing when parent layout components (e.g. WorkspaceHome) re-render.
 */
