...
assert_workflow_separates_controller_from_required_check() {
  ...
  assert_in_file "github.event_name == 'workflow_dispatch'" "$workflow"
  assert_in_file "github.event_name == 'workflow_run'" "$workflow"
  assert_not_in_file "github.event_name == 'workflow_dispatch' && github.event.inputs.pr_number != ''" "$workflow"
  assert_not_in_file "github.event_name == 'workflow_run' && github.event.workflow_run.pull_requests\[0\].number != ''" "$workflow"
